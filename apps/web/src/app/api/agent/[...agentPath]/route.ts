...
import { normalizePath, getPrivacyDecisions, isPathHidden } from '@/lib/agentPrivacy'
import { signAgentToken } from '@storva/shared-auth'
import { NextRequest, NextResponse } from 'next/server'

// Privacy helpers (normalizePath / getPrivacyDecisions / isPathHidden) now live
// in '@/lib/agentPrivacy' so the direct-upload token route can reuse the exact
// same logic instead of re-implementing it and risking the two drifting apart.
